...
namespace Example03
{
    public partial class MainWindow : Form
    {
        ...
        private void Render()
        {
            ...
            PokemonPowerUp.Enabled = PlayerCandy >= PokemonPowerUpCandy && PlayerStardust >= PokemonPowerUpStardust;
            PokemonTypeLabel.Text = string.Format("類型: {0},{1}", PokemonTypes[0], PokemonTypes[1]);
        }
        ...
        private void PokemonPowerUp_Click(object sender, EventArgs e)
        {
